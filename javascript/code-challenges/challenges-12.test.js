...
const count = (target, input) => {
  return input.reduce((acc, array) => {
    return acc + array.reduce((countInArray, element) => {
      return countInArray + (element === target ? 1 : 0);
    }, 0);
  }, 0);
};
/* ------------------------------------------------------------------------------------------------
...
const totalSum = (input) => {
  return input.reduce((acc, array) => {
    return acc + array.reduce((sum, element) => sum + element, 0);
  }, 0);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
let findShortest = (data) => {
  const shortestCharacter = data.reduce((minHeightCharacter, currentCharacter) => {
    if (!minHeightCharacter || parseInt(currentCharacter.height) < parseInt(minHeightCharacter.height)) {
