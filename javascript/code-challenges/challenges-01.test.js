...
// Function to transform a string to uppercase and add "!"
const greeting = (str) => {
...
const speaker = (arr, callback) => {
  ...
  arr.forEach(function (str) {
    modifiedStrings.push(callback(str));
  });
...
// Function to push a value into an array
const addValues = (arr, value) => {
  arr.push(value);
};

// Function to add a number to an array multiple times using a callback
